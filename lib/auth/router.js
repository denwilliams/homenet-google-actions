...
const CLIENT_ID = 'ZxjqWpsYj3';
const CLIENT_SECRET = 'hIMH3uWlMVrqa7FAbKLBoNUMCyLCtv';
const DEMO_AUTH_CODE = 'aaabbb';
const DEFAULT_TOKEN = {
  token_type: 'bearer',
  access_token: 'ahdfabasnbjkadiuaiuasnjad',
  refresh_token: '832893bu3b3inudkndh89e3niou23'
};
